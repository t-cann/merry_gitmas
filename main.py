...
text.write("Python", font=("Avenir", 30, "bold"), align="right") 
text.color("black") 
text.write("Peeps", font=("Avenir", 30, "normal"), align="left") 
text.setposition(50,140) 
text.write("from the", font=("Apple Chancery", 20, "bold"), align="right") 

if my_month == 12 and my_day == 25:
    text.setposition(00,-100)
    text.color("red") 
    text.write("Merry", font=("Apple Chancery", 40, "bold"), align="center")
    text.setposition(00,-110)
    text.write("Gitmas", font=("Apple Chancery", 40, "bold"), align="center")
elif my_month == 12 and my_day > 25:
    text.setposition(00,-100)
    text.color("red") 
    text.write(str(my_day-24), font=("Apple Chancery", 40, "bold"), align="center")
    text.setposition(0,-130)
    text.write("day of Christmas!", font=("Apple Chancery", 20, "bold"), align="center" )
text.hideturtle() 
